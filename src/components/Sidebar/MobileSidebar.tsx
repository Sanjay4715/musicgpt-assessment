...
const MobileSidebar = ({ onClose }: MobileSidebarProps) => {
  return (
    ...
    >
      ...
      <motion.aside
        data-id="mobile-sidebar"
        className="shadow-lg fixed flex flex-col left-0 top-0 h-full w-(--sidebar-mobile-width) bg-white/3 backdrop-blur-[30px] min-[960px]:hidden"
